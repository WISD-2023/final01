    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-4 mr-auto ml-32">
                ...
                <!-- 購物車按鈕 -->
                <div>
                    <x-nav-link :href="route('cart.index')" :active="request()->routeIs('cart.index')" class="hover:underline">
                        {{ __('購物車') }}
                    </x-nav-link>
                </div>
                @else
                ...
                <!-- 訂單狀態按鈕 -->
                <div>
                    <x-nav-link :href="route('order.index')" :active="request()->routeIs('order.index')" class="hover:underline">
                        {{ __('訂單狀態') }}
                    </x-nav-link>
                </div>
            </div>
